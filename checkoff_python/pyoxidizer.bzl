...
def make_exe():
    ...
    policy.set_environment_variable("SSL_CERT_FILE", "/etc/ssl/certs/ca-certificates.crt")
    policy.set_environment_variable("REQWEST_CA_BUNDLE", "/etc/ssl/certs/ca-certificates.crt")
